...
public class SeniorManagerLogonca extends JFrame implements ActionListener
 { 
	JMenuBar mb;
	...
	public SeniorManagerLogonca(String title)
  	{

		super("  CASH COLLECTION  ");
		try{
...
{System.exit(0);}
 ...
 //--------------------------------------------------------------------------------			
		...
		{
			SeniorManagerLogonca ss = new SeniorManagerLogonca("gf");
