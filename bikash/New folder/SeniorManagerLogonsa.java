...
public class SeniorManagerLogonsa extends JFrame implements ActionListener
 { 
	JMenuBar mb;
	...
	public SeniorManagerLogonsa(String title)
  	{

		super(" Senior Assistant  ");
		try{
...
{System.exit(0);}
 ...
 //--------------------------------------------------------------------------------			
		...
		{
			SeniorManagerLogonsa ss = new SeniorManagerLogonsa("gf");
